...
# Установка для всех агентов: кратко, без рассуждений, не выдумывать данные.
_DESIGN_GUIDANCE = (
    "\n\nПРИНЦИПЫ РАБОТЫ:\n"
    "• Отвечай КРАТКО и только по существу: конкретный результат, таблицы, цифры. "
    "НЕ показывай ход рассуждений, не пиши вступления и размышления.\n"
    "• Считай всё, что можно посчитать, САМОСТОЯТЕЛЬНО.\n"
    "• НЕ выдумывай недостающие исходные данные. Если для расчёта критично не хватает "
    "данных — коротким списком перечисли, что именно нужно от пользователя, и остановись.\n"
    "• Проектируй индивидуально под задачу. База знаний — это ПРИМЕРЫ и ориентиры, "
    "а не строгие требования.\n"
    "• Если по проекту присланы материалы (готовый проект, отчёт лаборатории) — это "
    "ПРИОРИТЕТ: работай с ними, базу знаний используй лишь как справку.\n"
    "/no_think"
)
